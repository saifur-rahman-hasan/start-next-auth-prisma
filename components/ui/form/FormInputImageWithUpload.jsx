...
function FormInputImageWithUpload({ label = 'photo', name= 'photo', profileUser = {} }) {
				...
				{(selectedImage || profileUser?.image) && (
					<div className="relative">
						<img
							...
							className="h-10 w-10 text-gray-300 rounded-full ring-4 ring-indigo-500 ring-offset-1"
...
export default FormInputImageWithUpload;
